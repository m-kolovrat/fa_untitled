            ...
            >
                ...
                {type === "transparent-gradient" && (
                    <div className="absolute -top-4 -left-4 grid grid-cols-2 blur-3xl">
                        {/* Fixed decorative hues (not design tokens) — pinned to the pre-sync Tailwind stock
                            values so this illustration renders identically after the palette reset. */}
                        <div className="size-20 rounded-tl-full bg-[oklch(65.6%_0.241_354.308)] opacity-30 mix-blend-normal" />
                        <div className="size-20 rounded-tr-full bg-[oklch(70.5%_0.213_47.604)] opacity-50 mix-blend-normal" />
                        <div className="size-20 rounded-bl-full bg-[oklch(62.3%_0.214_259.815)] opacity-30 mix-blend-normal" />
                        <div className="size-20 rounded-br-full bg-[oklch(72.3%_0.219_149.579)] opacity-30 mix-blend-normal" />
                    </div>
                )}
