...
export const Tag = ({
    ...
    return (
        <AriaTag
            ...
            className={(state) =>
                cx(
                    "flex cursor-default items-center gap-0.75 rounded-sm bg-primary text-secondary ring-1 ring-primary outline-focus-ring transition ring-inset focus-visible:outline-2 focus-visible:outline-offset-2",
